...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xdata address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xdata: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Xdata Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xdata addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xdata addresses"));
    ...
    openAction->setStatusTip(tr("Open a xdata: URI or payment request"));
...
{
    QString strTitle = tr("Xdata Core"); // default title
