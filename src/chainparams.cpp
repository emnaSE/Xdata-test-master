...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsStartBlock = 9999999; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        ...
        consensus.BIP65Height = 9999999; // 00000000000076d8fcea02ec0963de4abfd01e771fec0863f960c2c64fe6f357
        consensus.BIP66Height = 9999999; // 00000000000b1fa2dfa312863570e13fae9ca7b5566cb27e55422620b469aefa
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Xdata: 1 day
        consensus.nPowTargetSpacing = 5 * 60; //    Xdata: 5 minutes
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 999999999999ULL; //OFF
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 999999999999ULL; 

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 999999999999ULL; //OFF
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 999999999999ULL; 

        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 999999999999ULL; //OFF
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 999999999999ULL; //OFF
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 999999999999ULL; //OFF
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 999999999999ULL; //OFF
     ...
     //   assert(consensus.hashGenesisBlock == uint256S("0x00000ffd590b1485b3caadc19b22e6379c733355108f107a430458cdf3407ab6"));
       ...
       /* checkpointData = (CCheckpointData) {
        ...
        chainTxData = ChainTxData{
            genesis.GetBlockTime(), // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("xdatadot.io",  "testnet-seed.xdatadot.io"));
...
public:
    CDevNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("xdataevo.org",  "devnet-seed.xdataevo.org"));
