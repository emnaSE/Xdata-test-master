...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Xdata address\n"
            "  payee          - Print the masternode payout Xdata address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Xdata address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "xdata",               "masternode",             &masternode,             true,  {} },
    { "xdata",               "masternodelist",         &masternodelist,         true,  {} },
    { "xdata",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "xdata",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
