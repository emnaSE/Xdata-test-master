/* src/config/Xdata-config.h.  Generated from Xdata-config.h.in by configure.  */
/* src/config/Xdata-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Xdata Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Xdata Core"
...
#define PACKAGE_BUGREPORT "https://github.com/xdata/"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Xdata Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Xdata Core 0.51.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xdatacore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://xdata.one/"
