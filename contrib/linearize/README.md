...
## Step 0: Install xdata_hash

https://github.com/dashpay/xdata_hash
...
JSON-RPC server. Running `xdatad` or `xdata-qt -server` will be sufficient.
...
* `input`: xdatad blocks/ directory containing blkNNNNN.dat
