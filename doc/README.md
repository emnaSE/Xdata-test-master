...
Unpack the files into a directory, and then run xdata-qt.exe.

### OS X

Drag Xdata-Qt to your applications folder, and then run Xdata-Qt.

### Need Help?

* See the [Dash documentation](https://docs.dash.org)
for help and more information.
* See the [Dash Developer Documentation](https://xdata-docs.github.io/) 
for technical specifications and implementation details.
* Ask for help on [Dash Nation Discord](http://xdatachat.org)
...
* Discuss on [Dash Nation Discord](http://xdatachat.org)
